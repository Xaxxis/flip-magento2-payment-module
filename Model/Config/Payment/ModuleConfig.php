...
class ModuleConfig
{
    ...
    {
        return $this->_scopeConfig->getValue(path: self::BASE_CONFIG_PATH . $pathXML);
    }
    ...
    {
        return $this->getDataConfig('is_live_mode') === 1;
    }
    ...
    {
        return $this->getDataConfig('is_redirect') === 1;
    }
    ...
    {
        if ($this->isLive()) {
            return $this->encryptor->decrypt($this->getDataConfig('live_api_secret_key'));
        } else {
            return $this->encryptor->decrypt($this->getDataConfig('test_api_secret_key'));
        }
    }
    ...
    {
        if ($this->isLive()) {
            return $this->encryptor->decrypt($this->getDataConfig('live_validation_key'));
        } else {
            return $this->encryptor->decrypt($this->getDataConfig('test_validation_key'));
        }
    }
    ...
    {
        return $this->_scopeConfig->getValue('payment/settings/flip_callback_log') === 1;
    }
    ...
    {
        return $this->_scopeConfig->getValue('payment/settings/flip_request_log') === 1;
    }
    ...
    {
        return $this->_scopeConfig->getValue('payment/settings/flip_debug_log') === 1;
    }
    ...
    {
        return $this->_scopeConfig->getValue('payment/settings/flip_exception') === 1;
    }
